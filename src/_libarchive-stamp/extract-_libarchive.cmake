...
#
get_filename_component(filename "/Users/mulgogi/src/tamatebako/libdwarfs/src/libarchive-3.7.9.tar.xz" ABSOLUTE)
get_filename_component(directory "/Users/mulgogi/src/tamatebako/libdwarfs/src/_libarchive" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-_libarchive${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-_libarchive${i}")
