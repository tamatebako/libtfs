...
#
get_filename_component(filename "/Users/mulgogi/src/tamatebako/libdwarfs/src/v3.2.5.tar.gz" ABSOLUTE)
get_filename_component(directory "/Users/mulgogi/src/tamatebako/libdwarfs/src/_libutfcpp" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-_libutfcpp${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-_libutfcpp${i}")
