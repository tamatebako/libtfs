...
*/
#if (_MSC_VER > 1900)
#define BOOST_COMP_MSVC_DETECTION BOOST_VERSION_NUMBER(_MSC_VER / 100, _MSC_VER % 100, BOOST_COMP_MSVC_BUILD)
#elif (_MSC_VER >= 1900)
#define BOOST_COMP_MSVC_DETECTION BOOST_VERSION_NUMBER(_MSC_VER / 100 - 5, _MSC_VER % 100, BOOST_COMP_MSVC_BUILD)
#else
#define BOOST_COMP_MSVC_DETECTION BOOST_VERSION_NUMBER(_MSC_VER / 100 - 6, _MSC_VER % 100, BOOST_COMP_MSVC_BUILD)
#endif
#endif
