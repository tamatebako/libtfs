...
class Path {
 ...
 public:
   ...
   */
  [[nodiscard]] bool is_absolute() const { return !path_.empty() && path_.front() == '/'; }

  /**
   * @brief Check if path is relative (does not start with '/')
   */
  [[nodiscard]] bool is_relative() const { return !path_.empty() && path_.front() != '/'; }

  /**
   * @brief Check if this is the root path "/"
   */
  [[nodiscard]] bool is_root() const { return path_ == "/"; }

  /**
   * @brief Get path length
   */
  [[nodiscard]] size_t length() const { return path_.length(); }
   ...
   */
  [[nodiscard]] std::string string() && { return std::move(path_); }
   ...
   */
  [[nodiscard]] std::string_view view() const { return path_; }

  /**
   * @brief Implicit conversion to string_view
   */
  operator std::string_view() const { return path_; }
